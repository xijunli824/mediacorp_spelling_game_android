...
//        }
    ...
    private void forceLoad(int dataSetId, Context context, @NonNull final GameDataCallback gameDataCallback) {
        ...
        switch (currentDataSetId){
            case 0:
                gameSetInputStream = context.getResources().openRawResource(R.raw.games_set_final_sample);
                questionSetInputStream = context.getResources().openRawResource(R.raw.questions_set_final_sample);
                break;
//            case 1:
